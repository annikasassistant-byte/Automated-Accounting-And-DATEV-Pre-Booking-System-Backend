...
export const REQUIRED_EXTRA_ACCOUNTS: SeedAccount[] = [
  ...
  },
  {
    ...
    isSystemProtected: true,
    notes:
      'Private seller purchases — no input VAT (empty BU). Identify for §25a overall-margin (Differenzbesteuerung). Legacy Konto 3220 migrated here.',
  },
  {
    number: '1577',
    ...
    type: 'asset',
    isSystemProtected: true,
    notes: 'Deductible input VAT under reverse charge §13b (marketplace fees)',
  },
  {
    number: '1787',
    ...
    type: 'liability',
    isSystemProtected: true,
    notes: 'Output VAT payable under reverse charge §13b (marketplace fees)',
  },
